...
function updateDailySummary(pm25, pm10, aqi) {
    ...
    const map = {
        1: { title: 'Buena',        text: 'El aire es adecuado para actividades al aire libre.',
             tips: ['Ideal para ejercicio al aire libre.', 'OK.'] },
        2: { title: 'Aceptable',    text: 'La calidad es aceptable; algunas personas muy sensibles podrían notar molestias.',
             tips: ['Si eres sensible, limita esfuerzos intensos prolongados.'] },
        3: { title: 'Moderada',     text: 'La calidad del aire podría afectar a grupos sensibles.',
             tips: ['Personas con asma o EPOC: lleven medicación.', 'Considera ejercicio moderado.'] },
        4: { title: 'Mala',         text: 'El aire no es saludable; minimiza la exposición.',
             tips: ['Reduce ejercicio intenso al aire libre.', 'Utiliza mascarilla si presentas síntomas.'] },
        5: { title: 'Muy mala',     text: 'Evita actividades al aire libre y protege a grupos sensibles.',
